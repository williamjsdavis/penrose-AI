const binary = (binop) => (v, w) => ({
    tag: "Binary",
    binop,
    left: v,
    right: w,
});
const nary = (op, bin) => (xs) => {
...
export const not = (v) => ({ tag: "Not", param: v });
/**
 * Return a conditional `if(cond) then v else w`.
 */
export const ifCond = (cond, v, w) => ({
    tag: "Ternary",
    cond,
    then: v,
    els: w,
...
//# sourceMappingURL=AutodiffFunctions.js.map