...
export declare const logAD: any;
export declare const EPS_DENOM = 0.00001;
export declare const variable: (val: number) => ad.Var;
/**
 ...
 */
export declare const makeGraph: (outputs: Omit<ad.Outputs<ad.Num>, "gradient">, getKey?: ((x: ad.Var) => number) | undefined) => ad.Graph;
/**
 * Construct a graph with a primary output but no secondary outputs.
 */
export declare const primaryGraph: (output: ad.Num, getKey?: ((x: ad.Var) => number) | undefined) => ad.Graph;
/**
 ...
 */
export declare const secondaryGraph: (outputs: ad.Num[], getKey?: ((x: ad.Var) => number) | undefined) => ad.Graph;
/**
 ...
 */
export declare const genCode: (...graphs: ad.Graph[]) => Promise<ad.Compiled>;
/**
 ...
 */
export declare const genCodeSync: (...graphs: ad.Graph[]) => ad.Compiled;
/** Generate an energy function from the current state (using `ad.Num`s only) */
export declare const genGradient: (inputs: ad.Var[], objectives: ad.Num[], constraints: ad.Num[]) => Promise<ad.Gradient>;
export declare const problem: ({ objective, constraints, }: ad.Description) => Promise<ad.Problem>;
export declare const compile: (xs: ad.Num[]) => Promise<(inputs: (x: ad.Var) => number) => number[]>;
