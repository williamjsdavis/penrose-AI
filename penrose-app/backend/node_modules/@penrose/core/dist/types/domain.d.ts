...
export type DomainStmt<T> = TypeDecl<T> | PredicateDecl<T> | FunctionDecl<T> | ConstructorDecl<T> | PreludeDecl<T> | NotationDecl<T> | SubTypeDecl<T>;
...
export interface Env {
    ...
    constructorsBindings: im.Map<string, [
        ApplyConstructor<A>,
        ConstructorDecl<C>
    ]>;
