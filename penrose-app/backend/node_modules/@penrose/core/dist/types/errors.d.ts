...
import { A, AbstractNode, C, Identifier, NodeType, SourceLoc, SourceRange } from "./ast.js";
import { Arg, TypeConstructor, TypeVar } from "./domain.js";
import { CompFunc, ConstrFunc, FuncParam, ObjFunc } from "./functions.js";
import { State } from "./state.js";
import { BinOp, BindingForm, ColorLit, Expr, GPIDecl, LayoutStages, Path, UOp } from "./style.js";
...
export type PenroseError = (DomainError & {
...
export type SubstanceError = ParseError | DuplicateName | TypeNotFound | TypeVarNotFound | TypeMismatch | ArgLengthMismatch | TypeArgLengthMismatch | VarNotFound | DeconstructNonconstructor | UnexpectedExprForNestedPred | InvalidSetIndexingError | DuplicateIndexError | DivideByZeroError | InvalidArithmeticValueError | UnsupportedIndexingError | FatalError;
export type DomainError = ParseError | TypeDeclared | TypeVarNotFound | TypeNotFound | DuplicateName | CyclicSubtypes | SymmetricTypeMismatch | SymmetricArgLengthMismatch;
...
export type StyleError = ParseError | GenericStyleError | StyleErrorList | InvalidColorLiteral | SelectorVarMultipleDecl | SelectorDeclTypeMismatch | SelectorRelTypeMismatch | SelectorFieldNotSupported | TaggedSubstanceError | SelectorAliasNamingError | InvalidGPITypeError | InvalidGPIPropertyError | InvalidFunctionNameError | InvalidObjectiveNameError | InvalidConstraintNameError | AssignAccessError | AssignGlobalError | AssignSubstanceError | BadElementError | BadIndexError | BinOpTypeError | CanvasNonexistentDimsError | CyclicAssignmentError | DeleteGlobalError | DeleteSubstanceError | MultipleLayoutError | MissingPathError | MissingShapeError | NestedShapeError | NotCollError | IndexIntoShapeListError | NotShapeError | NotValueError | OutOfBoundsError | PropertyMemberError | UOpTypeError | BadShapeParamTypeError | BadArgumentTypeError | MissingArgumentError | TooManyArgumentsError | FunctionInternalError | RedeclareNamespaceError | NotSubstanceCollectionError | NotStyleVariableError | LayerOnNonShapesError | RuntimeValueTypeError;
export type StyleWarning = ImplicitOverrideWarning | NoopDeleteWarning | LayerCycleWarning | ShapeBelongsToMultipleGroupsWarning | GroupCycleWarning | FunctionInternalWarning;
