...
export type SubStmt<T> = Decl<T> | DeclList<T> | Bind<T> | DeclBind<T> | EqualExprs<T> | EqualPredicates<T> | ApplyPredicate<T> | LabelDecl<T> | AutoLabel<T> | NoLabel<T>;
...
export type TypeConsApp<T> = Omit<TypeConstructor<T>, keyof TypeConsAppArgs<T>> & TypeConsAppArgs<T>;
...
export type SubExpr<T> = Identifier<T> | ApplyFunction<T> | ApplyConstructor<T> | Func<T> | Deconstructor<T> | StringLit<T>;
...
export type SubPredArg<T> = SubExpr<T> | ApplyPredicate<T>;
export type BooleanExpr<T> = ComparisonExpr<T> | BinaryBooleanExpr<T> | UnaryBooleanExpr<T> | BooleanConstant<T>;
...
export type NumExpr<T> = BinaryExpr<T> | UnaryExpr<T> | NumberConstant<T> | Identifier<T>;
