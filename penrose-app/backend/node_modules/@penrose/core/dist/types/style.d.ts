...
export type SelExpr<T> = SEBind<T> | SEFunc<T> | SEValCons<T> | SEFuncOrValCons<T>;
...
export type Expr<T> = AnnoFloat<T> | StringLit<T> | BoolLit<T> | ColorLit<T> | Path<T> | CompApp<T> | ObjFn<T> | ConstrFn<T> | BinOp<T> | StyVarExpr<T> | UOp<T> | List<T> | Tuple<T> | Vector<T> | GPIDecl<T> | Layering<T>;
...
export type ObjFn<T> = ASTNode<T> & Staged<T> & {
    tag: "ObjFn";
    body: FunctionCall<T> | InlineComparison<T>;
};
export type ConstrFn<T> = ASTNode<T> & Staged<T> & {
    tag: "ConstrFn";
    body: FunctionCall<T> | InlineComparison<T>;
};
...
export type Vary<T> = ASTNode<T> & Staged<T> & {
    tag: "Vary";
};
