...
import { Context, ResolvedName, ResolvedPath } from "../types/styleSemantics.js";
import { ShapeT, TypeDesc, UnionT, ValueShapeT, ValueT, ValueType } from "../types/types.js";
import { BoolV, Clip, ClipData, ClipDataV, Color, ColorV, FloatV, LListV, ListV, MatrixV, NoClip, PathCmd, PathDataV, PtListV, ShapeListV, StrV, TupV, Val, Value, VectorV } from "../types/value.js";
export declare const cartesianProduct: <Tin, Tout>(t1: Tin[], t2: Tin[], consistent: (t1: Tin, t2: Tin) => boolean, merge: (t1: Tin, t2: Tin) => Tout) => Tout[];
/**
 * Compute the combinations of pairs
 */
export declare const combinations2: <T>(list: T[]) => [T, T][];
/**
 ...
 */
export declare const safe: <T>(argument: T | undefined, message: string) => T;
...
export declare const isKeyOf: <T extends Record<string, unknown>>(key: string | number | symbol, obj: T) => key is keyof T;
/**
...
export declare const bBoxDims: (shape: Shape<number>) => [number, number];
...
export declare const shapeListV: (contents: Shape<ad.Num>[]) => ShapeListV<ad.Num>;
...
export declare const clipDataV: (contents: ClipData<ad.Num>) => ClipDataV<ad.Num>;
export declare const noClip: () => NoClip;
export declare const clipShape: (contents: Shape<ad.Num>) => Clip<ad.Num>;
export declare const describeType: (t: ValueShapeT) => TypeDesc;
export declare const valueT: (type: ValueType) => ValueT;
export declare const real2T: () => ValueT;
export declare const real3T: () => ValueT;
export declare const realT: () => ValueT;
export declare const unitT: () => ValueT;
export declare const realNT: () => ValueT;
export declare const natT: () => ValueT;
export declare const pathCmdT: () => ValueT;
export declare const colorT: () => ValueT;
export declare const pathTypeT: () => ValueT;
export declare const colorTypeT: () => ValueT;
export declare const real2NT: () => ValueT;
export declare const stringT: () => ValueT;
export declare const posIntT: () => ValueT;
export declare const booleanT: () => ValueT;
export declare const realNMT: () => ValueT;
export declare const shapeListT: () => ValueT;
export declare const shapeT: (type: ShapeType | "AnyShape") => ShapeT;
export declare const unionT: (...types: ValueShapeT[]) => UnionT;
export declare const rectlikeT: () => UnionT;
...
export declare const linePts: ({ start, end, }: LineProps<ad.Num>) => [ad.Num[], ad.Num[]];
export declare const getStart: ({ start }: LineProps<ad.Num>) => ad.Num[];
export declare const getEnd: ({ end }: LineProps<ad.Num>) => ad.Num[];
 ...
 */
export declare const getValueAsShapeList: <T>(val: Value<T>) => Shape<T>[];
export type ErrorLoc = {
    type: NodeType;
    range: SourceRange;
};
export declare const toErrorLoc: (node: {
    nodeType: NodeType;
    start: SourceLoc;
    end: SourceLoc;
}) => ErrorLoc;
export declare const locOrNone: (node: ASTNode<A>) => ErrorLoc[];
export declare const allWarnings: readonly ["BBoxApproximationWarning", "GroupCycleWarning", "ImplicitOverrideWarning", "LayerCycleWarning", "NoopDeleteWarning", "ShapeBelongsToMultipleGroups"];
export declare const noWarn: <T>(value: T) => MayWarn<T>;
export declare const noWarnFn: <T extends any[], S>(f: (...args: T) => S) => (...args: T) => MayWarn<S>;
export {};
