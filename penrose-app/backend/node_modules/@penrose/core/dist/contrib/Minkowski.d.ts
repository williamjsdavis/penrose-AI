...
import { ImplicitEllipse } from "./ImplicitShapes.js";
/**
 ...
 */
export declare const rectangleDifference: ([, tl1, , br1]: ad.Pt2[], [, tl2, , br2]: ad.Pt2[], padding: ad.Num) => [ad.Pt2, ad.Pt2];
/**
 ...
 */
export declare const containsConvexPolygonPoints: (p1: ad.Num[][], p2: ad.Num[], padding: ad.Num) => ad.Num;
/**
 ...
 * @param padding Padding around the Minkowski sum.
 */
export declare const halfPlaneEllipseSDF: (lineSegment: ad.Num[][], c: ad.Pt2, rx: ad.Num, ry: ad.Num, insidePoint: ad.Num[], padding: ad.Num) => ad.Num;
/**
 ...
 */
export declare const overlappingPolygonPointsEllipse: (polygonPoints: ad.Num[][], c: ad.Pt2, rx: ad.Num, ry: ad.Num, padding: ad.Num) => ad.Num;
/**
