 ...
 */
export declare const ellipseToImplicit: (e: Ellipse<ad.Num>, padding: ad.Num, factor?: ad.Num) => ImplicitEllipse;
export declare const absEllipseToImplicit: (c: ad.Pt2, rx: ad.Num, ry: ad.Num, padding: ad.Num, factor?: ad.Num) => ImplicitEllipse;
/**
 * Return implicit ellipse parameters from an explicit circle.
 * @param circle Explicit circle shape.
 */
export declare const circleToImplicitEllipse: (circle: Circle<ad.Num>, padding: ad.Num, factor?: ad.Num) => ImplicitEllipse;
export declare const absCircleToImplicitEllipse: (c: ad.Pt2, r: ad.Num, padding: ad.Num, factor?: ad.Num) => ImplicitEllipse;
